	...
	function Window:CreateTab(Name, Image, Ext)
		...
		function Tab:CreateLabel(LabelText: string, Icon: number, Color: Color3, IgnoreTheme: boolean)
			...
			function LabelValue:Set(NewLabel, Icon, Color)
				if labelRemoved or not Label then
					return
				end
			...
			local themeConnection = Rayfield.Main:GetPropertyChangedSignal("BackgroundColor3"):Connect(function()
				if labelRemoved or not Label or not Label.Parent then
					return
				end
			...
			LabelValue.Destroy = LabelValue.Remove
		...
		function Tab:CreateDropdown(DropdownSettings)
			...
			DropdownSearchIcon.Position = UDim2.new(0, 10, 0, 7)
